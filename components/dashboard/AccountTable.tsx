...
interface AccountTableProps {
  refreshOne: (accountId: string) => Promise<{ success: boolean; error?: string }>;
        ...
        <Table className="w-full min-w-[900px]">
          <TableHeader className="sticky top-0 bg-white z-10">
            <TableRow className="border-t">
              ...
              <TableHead className="text-center bg-white">Recent Posts</TableHead>
              <TableHead className="text-center bg-white">
                <SortButton field="lastPostView" label="Recent Posts View" />
              </TableHead>
              <TableHead className="text-center bg-white">
                <TagFilterDropdown />
              </TableHead>
